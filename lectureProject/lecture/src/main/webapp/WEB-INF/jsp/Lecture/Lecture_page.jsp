    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="Lecture_listpage" class="list-group-item active">강좌</a>
        ...
        <div class="col-lg-9">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h1>${lecture_content.get(0).name}</h1>
                    <a style=" float: right">교수: ${lecture_content.get(0).professor_id}</a><br>
                    <h5>&nbsp;&nbsp;수업 시간</h5>

                    <c:forEach var="i" begin="0" end="${size}">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${time[i]}<br>
                    </c:forEach>
                    <a href="Lecture_assignment" class="btn btn-success" style="float: right">과제확인</a>
                </div>
                <jsp:include page="Lecture_detail.jsp" flush="false"/>
            </div>
